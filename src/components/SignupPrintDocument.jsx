...
export default function SignupPrintDocument(props) {
  ...
  const handlePrint = () => {
    try {
      if (tab === "application") printApplicationDocument(data);
    ...
    <div className="print-overlay">
      <div className="print-modal">
        <div className="print-toolbar no-print">
          <span style={{ fontWeight: 700, fontSize: 15 }}>📄 신청서 미리보기 (1페이지씩)</span>
          <div className="print-doc-tabs">
            <button
              type="button"
              className={`print-doc-tab ${tab === "application" ? "active" : ""}`}
            ...
            <button
              type="button"
              className={`print-doc-tab ${tab === "withholding" ? "active" : ""}`}
